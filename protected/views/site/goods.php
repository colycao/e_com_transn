    <div class="content">
        ...
        <ul>
          ...
          <label class="item_tit"><?php echo Yii::t('t2b', '目标语言'); ?>：</label>
              ...
              <li><a class="btn_blue fl btn_upload"><?php echo Yii::t('t2b', '一键导入商品信息'); ?></a><a class="btn_yellow fl"><?php echo Yii::t('t2b', '批量导入商品信息'); ?></a></li>
    ...
    <p class="order_money"><span><?php echo Yii::t('t2b', '合计'); ?>：<strong>3551</strong> <?php echo Yii::t('t2b', '字'); ?></span><span><?php echo Yii::t('t2b', '价格'); ?>：<strong>890</strong> <?php echo Yii::t('t2b', '元'); ?></span></p>
            <p class="order_save">
				<?php echo CHtml::link(CHtml::encode(Yii::t('t2b', '保   存')), array('site/goods', 'setup' => 'list'), array('class' => 'btn_blue_big fl')); ?>
				<?php echo CHtml::link(CHtml::encode(Yii::t('t2b', '保存并继续添加')), array('site/goods'), array('class' => 'btn_blue_big fl')); ?>
			</p>
        </div>
    </div>
</div>
