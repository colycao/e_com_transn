    <div class="content">
        ...
        <ul>
        	<li style="position:relative; z-index:1;">
				...
				<?php echo CHtml::link(CHtml::encode("查看已添加列表"), array('site/goods', 'setup' => 'list'), array('class' => 'btn_viewlist')); ?>
            </li>
            <li><a class="btn_blue fl btn_upload">一键导入商品信息</a><a class="btn_yellow fl">批量导入商品信息</a></li>
            ...
            <li><label>基本信息：</label><input class="input_01 w410"><span>字数：12</span></li>
		...
		<div class="order_do">
            ...
            <p class="order_save">
				<?php echo CHtml::link(CHtml::encode("保   存"), array('site/goods', 'setup' => 'list'), array('class' => 'btn_blue_big fl')); ?>
